...
- [ ] App title finalized (`app-title.txt`)
- [ ] Short and full descriptions finalized
      (`short-description.txt`, `full-description.txt`)
- [ ] High-resolution icon uploaded (`graphics/app-icon-512.png`)
- [ ] Feature graphic uploaded
- [ ] Phone screenshots uploaded (minimum 2, recommended 6+) — include the
