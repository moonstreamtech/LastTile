...
T["en"] = {
    ...
    "tutorial_step_hazards_and_shield_initial": "These are hazardous tiles — they damage you if left on the board.\nTo clear one, press and hold SHIELD, then drag it onto a hazard.",
    ...
    "tutorial_step_leaderboard_instruction_v2": "Tap the LEADERBOARD button, then tap your own row to set your name.",
